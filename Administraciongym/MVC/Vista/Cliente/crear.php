...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="index.php?controlador=cliente&accion=index" class="btn btn-secondary">
            <i class="fas fa-arrow-left"></i> Volver al listado
        </a>
    </div>

    <form action="index.php?controlador=cliente&accion=guardar" method="post">
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3" id="otroObjetivoDiv" style="display: none;">
