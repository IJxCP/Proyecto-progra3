...
unset($_SESSION['error_login']); // Limpiar el mensaje después de usarlo

// Verificar si existe la cookie de recordar usuario
...
<main class="form-signin">
    ...
    <form method="POST" action="../../Controladores/LoginControlador.php">
