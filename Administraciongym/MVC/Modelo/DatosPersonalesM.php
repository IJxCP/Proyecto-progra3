<?php
require_once('C:/xampp/htdocs/Administraciongym/MVC/Modelo/Conexion.php');
...
class DatosPersonalesM {
    public function BuscarId($id) {
        ...
        $sql = "SELECT ID, NOMBRE, APELLIDO1, APELLIDO2, FECHA_NACIMIENTO, TELEFONO, CORREO, DIRECCION 
    ...
    public function Insertar(DatosPersonales $datosPersonales) {
        $conexion = new Conexion();
        $sql = "INSERT INTO datospersonales (NOMBRE, APELLIDO1, APELLIDO2, FECHA_NACIMIENTO, TELEFONO, CORREO, DIRECCION) 
