...
<head>
    ...
    <script>
        function seleccionarTipo(tipo) {
            // Actualizar el campo oculto con el tipo seleccionado
            document.getElementById('tipo_analisis').value = tipo;

            // Actualizar la apariencia visual para mostrar el tipo seleccionado
            ...
            // Mostrar el campo de resultado apropiado según el tipo
        ...
        function mostrarCampoResultado(tipo) {
            ...
            // Mostrar el campo apropiado según el tipo
            switch(tipo) {
        ...
        function prepararEnvio() {
            ...
            // Actualizar el campo oculto de resultado
...
<div class="container">
    ...
    <form action="index.php?controlador=analisisdatos&accion=guardar" method="post" onsubmit="return prepararEnvio()">
        ...
        <!-- Campo de resultado genérico (oculto) -->
        <input type="hidden" id="resultado" name="resultado" value="">

        <!-- Campos específicos para cada tipo de análisis -->
...
<script>
    // Si hay un cliente preseleccionado, enfocar en el tipo de análisis
